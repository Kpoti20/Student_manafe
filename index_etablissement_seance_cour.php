...
<form class="w3-container">
  ...
  <select name="sx" class="w3-select" id="sx" >
                <option value="">Selectionnez le professeur</option>
  ...
  <p><button class="w3-btn w3-teal w3-round-xxlarge">Sauvegarder</button>
  <button class="w3-btn w3-teal w3-round-xxlarge">Annuler</button></p>
</form><br/>
