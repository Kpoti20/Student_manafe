...
if(isset($_POST['formconnexion']))
{
  ...
  if (!empty($mailconnect) AND !empty($mdpconnect)) {
    ...
    if ($userexist==1) {
      ...
      header("location:index_etablissement_filiere.php?id=".$_SESSION['id']);
    }else{
...
<div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
  ...
  <div class="w3-row w3-container" id="plans">
    <div class="w3-center w3-padding-64">
      <span class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">Connexion Etablissement</span>
    </div>
	<div class="col-sm-8">
     
      <form class="w3-container w3-card-4" method="POST" action="<?php echo htmlspecialchars("index_etablissement_connexion.php");?>">
		  <!--<h2 class="w3-text-blue">Inscription Etablissement</h2>-->
		  
		  <p>     
		  <label for="email" class="w3-text-black"><b>Mail</b></label>
		  <input class="w3-input w3-border" type="email"  id="email" name="mailconnect" placeholder="Entrer le mail" ></p>
		  <p>
			<label for="pwd" class="w3-text-black"><b>Mot de passe</b></label>
		  <input class="w3-input w3-border" type="password"  placeholder="Entrer le mot de passe" id="pwd" name="mdpconnect" >
		  </p>
		  <p>      
		  <button type="submit" name="formconnexion" class="w3-btn w3-black">Connexion</button>
